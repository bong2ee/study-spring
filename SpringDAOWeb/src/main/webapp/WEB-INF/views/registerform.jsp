...
<body>
	...
	<form:form modelAttribute="user">
		...
		<label for="">아이디</label>
		<input class="input-field" type="text" name="id" placeholder="5~12자리의 영대소문자,숫자 조합" />
		...
		<label for="">이메일</label>
		<input class="input-field" type="text" name="email" placeholder="sclee@gmail.com" />
	...
	<script type="text/javascript">
		...
		function setMessage(msg, element) {
			...
			if(element) {
				element.select();		//값이 잘못 입력되었을때 그 요소를 선택되게 하는 정렬
			}
